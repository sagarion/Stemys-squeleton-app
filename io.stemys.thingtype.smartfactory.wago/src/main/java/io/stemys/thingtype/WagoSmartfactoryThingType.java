...
public class WagoSmartfactoryThingType {
    private static final Logger s_logger = LoggerFactory.getLogger(WagoSmartfactoryThingType.class);
    ...
    public WagoSmartfactoryThingType() {
        super();
